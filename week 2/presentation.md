...
Debian memiliki beberapa cabang distribusi, seperti oldstable, stable, testing, dan unstable, bersama dengan cabang eksperimental. Distribusi Stable adalah yang resmi dan disarankan karena hanya mendapat pembaruan keamanan dan perbaikan bug. Oldstable adalah versi sebelumnya yang didukung oleh tim Debian untuk periode tertentu. Testing digunakan untuk persiapan versi stabil berikutnya, sementara Unstable (Sid) adalah versi inovatif tetapi tidak stabil. Eksperimental adalah repositori untuk menguji versi alpha atau beta perangkat lunak, bukan distribusi resmi Debian.